        ...
        public void ParseSeed(string filename)
        {
            ...
            while (streamReader.EndOfStream == false)
            {
                ...
                if (codes.Length == 5)
                {
                    ...
                    {
                        if (data.codes.Keyblades.Contains(codes[2]) && codes[4] == "0000019F") //detect keyblades with second chance
                        {
                            keybladeHasSC = true;
                            data.codes.itemCodes.Remove(415);
                            int KeybladeID = 41;


                            if (codes[2] == "11CDF1E6") //Oathkeeper
                            {
                                keybladeSCAnchor = 0x35A2;
                                KeybladeID = 042;
                            }
                            else if (codes[2] == "11CDF1F6") //Oblivion
                            {
                                keybladeSCAnchor = 0x35A3;
                                KeybladeID = 043;
                            }
                            else if (codes[2] == "11CDF466") //Star Seeker
                            {
                                keybladeSCAnchor = 0x367B;
                                KeybladeID = 480;
                            }
                            else if (codes[2] == "11CDF476") //Hidden Dragon
                            {
                                keybladeSCAnchor = 0x367C;
                                KeybladeID = 481;
                            }
                            else if (codes[2] == "11CDF4A6") //Hero's Crest
                            {
                                keybladeSCAnchor = 0x367F;
                                KeybladeID = 484;
                            }
                            else if (codes[2] == "11CDF4B6") //Monochrome
                            {
                                keybladeSCAnchor = 0x3680;
                                KeybladeID = 485;
                            }
                            else if (codes[2] == "11CDF4C6") //Follow the Wind
                            {
                                keybladeSCAnchor = 0x3681;
                                KeybladeID = 486;
                            }
                            else if (codes[2] == "11CDF4D6") //Circle of Life
                            {
                                keybladeSCAnchor = 0x3682;
                                KeybladeID = 487;
                            }
                            else if (codes[2] == "11CDF4E6") //Photon Debugger
                            {
                                keybladeSCAnchor = 0x3683;
                                KeybladeID = 488;
                            }
                            else if (codes[2] == "11CDF4F6") //Gull Wing
                            {
                                keybladeSCAnchor = 0x3684;
                                KeybladeID = 489;
                            }
                            else if (codes[2] == "11CDF506") //Rumbling Rose
                            {
                                keybladeSCAnchor = 0x3685;
                                KeybladeID = 490;
                            }
                            else if (codes[2] == "11CDF516") //Guardian Soul
                            {
                                keybladeSCAnchor = 0x3686;
                                KeybladeID = 491;
                            }
                            else if (codes[2] == "11CDF526") //Wishing Lamp
                            {
                                keybladeSCAnchor = 0x3687;
                                KeybladeID = 492;
                            }
                            else if (codes[2] == "11CDF536") //Decisive Pumpkin
                            {
                                keybladeSCAnchor = 0x3688;
                                KeybladeID = 493;
                            }
                            else if (codes[2] == "11CDF546") //Sleeping Lion
                            {
                                keybladeSCAnchor = 0x3689;
                                KeybladeID = 494;
                            }
                            else if (codes[2] == "11CDF556") //Sweet Memories
                            {
                                keybladeSCAnchor = 0x368A;
                                KeybladeID = 495;
                            }
                            else if (codes[2] == "11CDF566") //Mysterious Abyss
                            {
                                keybladeSCAnchor = 0x368B;
                                KeybladeID = 496;
                            }
                            else if (codes[2] == "11CDF576") //Fatal Crest
                            {
                                keybladeSCAnchor = 0x368C;
                                KeybladeID = 497;
                            }
                            else if (codes[2] == "11CDF586") //Bond of Flame
                            {
                                keybladeSCAnchor = 0x368D;
                                KeybladeID = 498;
                            }
                            else if (codes[2] == "11CDF596") //Fenrir
                            {
                                keybladeSCAnchor = 0x368E;
                                KeybladeID = 499;
                            }
                            else if (codes[2] == "11CDF5A6") //Ultima Weapon
                            {
                                keybladeSCAnchor = 0x368F;
                                KeybladeID = 500;
                            }
                            else if (codes[2] == "11CDF5F6") //Two Become One
                            {
                                keybladeSCAnchor = 0x3698;
                                KeybladeID = 543;
                            }
                            else if (codes[2] == "11CDF606") //Winner's Proof
                            {
                                keybladeSCAnchor = 0x3699;
                                KeybladeID = 544;
                            }
                            else if (codes[2] == "11CDF1D6") //Kingdom Key
                            {
                                keybladeHasSC = false;
                                FormkeybladeHasSC = true;
                                //KeybladeID = 041;
                                KeybladeID = 415;
                            }
                            else if (codes[2] == "11CDF206") //Detection Saber
                            {
                                keybladeHasSC = false;
                                FormkeybladeHasSC = true;
                                //KeybladeID = 044;
                            ...
                            else if (codes[2] == "11CDF216") //Edge Of Ultima
                            {
                                keybladeHasSC = false;
                                FormkeybladeHasSC = true;
                                //KeybladeID = 045;
                            ...
                            data.codes.itemCodes.Add(KeybladeID, "SecondChance");
                        }

                        if (data.codes.Keyblades.Contains(codes[2]) && codes[4] == "000001A0") //detect keyblades with once more
                        {
                            keybladehasOM = true;
                            data.codes.itemCodes.Remove(416);
                            int KeybladeID = 41;


                            if (codes[2] == "11CDF1E6") //Oathkeeper
                            {
                                keybladeOMAnchor = 0x35A2;
                                KeybladeID = 042;
                            }
                            else if (codes[2] == "11CDF1F6") //Oblivion
                            {
                                keybladeOMAnchor = 0x35A3;
                                KeybladeID = 043;
                            }
                            else if (codes[2] == "11CDF466") //Star Seeker
                            {
                                keybladeOMAnchor = 0x367B;
                                KeybladeID = 480;
                            }
                            else if (codes[2] == "11CDF476") //Hidden Dragon
                            {
                                keybladeOMAnchor = 0x367C;
                                KeybladeID = 481;
                            }
                            else if (codes[2] == "11CDF4A6") //Hero's Crest
                            {
                                keybladeOMAnchor = 0x367F;
                                KeybladeID = 484;
                            }
                            else if (codes[2] == "11CDF4B6") //Monochrome
                            {
                                keybladeOMAnchor = 0x3680;
                                KeybladeID = 485;
                            }
                            else if (codes[2] == "11CDF4C6") //Follow the Wind
                            {
                                keybladeOMAnchor = 0x3681;
                                KeybladeID = 486;
                            }
                            else if (codes[2] == "11CDF4D6") //Circle of Life
                            {
                                keybladeOMAnchor = 0x3682;
                                KeybladeID = 487;
                            }
                            else if (codes[2] == "11CDF4E6") //Photon Debugger
                            {
                                keybladeOMAnchor = 0x3683;
                                KeybladeID = 488;
                            }
                            else if (codes[2] == "11CDF4F6") //Gull Wing
                            {
                                keybladeOMAnchor = 0x3684;
                                KeybladeID = 489;
                            }
                            else if (codes[2] == "11CDF506") //Rumbling Rose
                            {
                                keybladeOMAnchor = 0x3685;
                                KeybladeID = 490;
                            }
                            else if (codes[2] == "11CDF516") //Guardian Soul
                            {
                                keybladeOMAnchor = 0x3686;
                                KeybladeID = 491;
                            }
                            else if (codes[2] == "11CDF526") //Wishing Lamp
                            {
                                keybladeOMAnchor = 0x3687;
                                KeybladeID = 492;
                            }
                            else if (codes[2] == "11CDF536") //Decisive Pumpkin
                            {
                                keybladeOMAnchor = 0x3688;
                                KeybladeID = 493;
                            }
                            else if (codes[2] == "11CDF546") //Sleeping Lion
                            {
                                keybladeOMAnchor = 0x3689;
                                KeybladeID = 494;
                            }
                            else if (codes[2] == "11CDF556") //Sweet Memories
                            {
                                keybladeOMAnchor = 0x368A;
                                KeybladeID = 495;
                            }
                            else if (codes[2] == "11CDF566") //Mysterious Abyss
                            {
                                keybladeOMAnchor = 0x368B;
                                KeybladeID = 496;
                            }
                            else if (codes[2] == "11CDF576") //Fatal Crest
                            {
                                keybladeOMAnchor = 0x368C;
                                KeybladeID = 497;
                            }
                            else if (codes[2] == "11CDF586") //Bond of Flame
                            {
                                keybladeOMAnchor = 0x368D;
                                KeybladeID = 498;
                            }
                            else if (codes[2] == "11CDF596") //Fenrir
                            {
                                keybladeOMAnchor = 0x368E;
                                KeybladeID = 499;
                            }
                            else if (codes[2] == "11CDF5A6") //Ultima Weapon
                            {
                                keybladeOMAnchor = 0x368F;
                                KeybladeID = 500;
                            }
                            else if (codes[2] == "11CDF5F6") //Two Become One
                            {
                                keybladeOMAnchor = 0x3698;
                                KeybladeID = 543;
                            }
                            else if (codes[2] == "11CDF606") //Winner's Proof
                            {
                                keybladeOMAnchor = 0x3699;
                                KeybladeID = 544;
                            }
                            else if (codes[2] == "11CDF1D6") //Kingdom Key
                            {
                                keybladehasOM = false;
                                FormkeybladehasOM = true;
                                //KeybladeID = 041;
                                KeybladeID = 416;
                            }
                            else if (codes[2] == "11CDF206") //Detection Saber
                            ...
                            data.codes.itemCodes.Add(KeybladeID, "OnceMore");
                        }

                        if (data.codes.Keyblades.Contains(codes[2]) && codes[4] == "0000021B") //detect keyblades with once more
                        {
                            keybladehasCM = true;
                            ...
                            if (codes[2] == "11CDF1E6") //Oathkeeper
                            {
                                keybladeCMAnchor = 0x35A2;
                                KeybladeID = 042;
                            }
                            else if (codes[2] == "11CDF1F6") //Oblivion
                            {
                                keybladeCMAnchor = 0x35A3;
                                KeybladeID = 043;
                            }
                            else if (codes[2] == "11CDF466") //Star Seeker
                            {
                                keybladeCMAnchor = 0x367B;
                                KeybladeID = 480;
                            }
                            else if (codes[2] == "11CDF476") //Hidden Dragon
                            {
                                keybladeCMAnchor = 0x367C;
                                KeybladeID = 481;
                            }
                            else if (codes[2] == "11CDF4A6") //Hero's Crest
                            {
                                keybladeCMAnchor = 0x367F;
                                KeybladeID = 484;
                            }
                            else if (codes[2] == "11CDF4B6") //Monochrome
                            {
                                keybladeCMAnchor = 0x3680;
                                KeybladeID = 485;
                            }
                            else if (codes[2] == "11CDF4C6") //Follow the Wind
                            {
                                keybladeCMAnchor = 0x3681;
                                KeybladeID = 486;
                            }
                            else if (codes[2] == "11CDF4D6") //Circle of Life
                            {
                                keybladeCMAnchor = 0x3682;
                                KeybladeID = 487;
                            }
                            else if (codes[2] == "11CDF4E6") //Photon Debugger
                            {
                                keybladeCMAnchor = 0x3683;
                                KeybladeID = 488;
                            }
                            else if (codes[2] == "11CDF4F6") //Gull Wing
                            {
                                keybladeCMAnchor = 0x3684;
                                KeybladeID = 489;
                            }
                            else if (codes[2] == "11CDF506") //Rumbling Rose
                            {
                                keybladeCMAnchor = 0x3685;
                                KeybladeID = 490;
                            }
                            else if (codes[2] == "11CDF516") //Guardian Soul
                            {
                                keybladeCMAnchor = 0x3686;
                                KeybladeID = 491;
                            }
                            else if (codes[2] == "11CDF526") //Wishing Lamp
                            {
                                keybladeCMAnchor = 0x3687;
                                KeybladeID = 492;
                            }
                            else if (codes[2] == "11CDF536") //Decisive Pumpkin
                            {
                                keybladeCMAnchor = 0x3688;
                                KeybladeID = 493;
                            }
                            else if (codes[2] == "11CDF546") //Sleeping Lion
                            {
                                keybladeCMAnchor = 0x3689;
                                KeybladeID = 494;
                            }
                            else if (codes[2] == "11CDF556") //Sweet Memories
                            {
                                keybladeCMAnchor = 0x368A;
                                KeybladeID = 495;
                            }
                            else if (codes[2] == "11CDF566") //Mysterious Abyss
                            {
                                keybladeCMAnchor = 0x368B;
                                KeybladeID = 496;
                            }
                            else if (codes[2] == "11CDF576") //Fatal Crest
                            {
                                keybladeCMAnchor = 0x368C;
                                KeybladeID = 497;
                            }
                            else if (codes[2] == "11CDF586") //Bond of Flame
                            {
                                keybladeCMAnchor = 0x368D;
                                KeybladeID = 498;
                            }
                            else if (codes[2] == "11CDF596") //Fenrir
                            {
                                keybladeCMAnchor = 0x368E;
                                KeybladeID = 499;
                            }
                            else if (codes[2] == "11CDF5A6") //Ultima Weapon
                            {
                                keybladeCMAnchor = 0x368F;
                                KeybladeID = 500;
                            }
                            else if (codes[2] == "11CDF5F6") //Two Become One
                            {
                                keybladeCMAnchor = 0x3698;
                                KeybladeID = 543;
                            }
                            else if (codes[2] == "11CDF606") //Winner's Proof
                            {
                                keybladeCMAnchor = 0x3699;
                                KeybladeID = 544;
                            }
                            else if (codes[2] == "11CDF1D6") //Kingdom Key
                            {
                                keybladehasCM = false;
                                FormkeybladehasCM = true;
                                //KeybladeID = 041;
                                KeybladeID = 539;
                            }
                            else if (codes[2] == "11CDF206") //Detection Saber
                            ...
                            data.codes.itemCodes.Add(KeybladeID, "ComboMaster");
                        }
                    }
